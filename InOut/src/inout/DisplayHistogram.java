...
public class DisplayHistogram extends JComponent implements MouseMotionListener
  ...
  private Font fontLarge = new Font("default",Font.ITALIC,15);
 ...
 */
  ...
  */
  protected void paintComponent(Graphics g)
    ...
    String ss="No of pixels";
    int line=100;
    g2d.setFont(fontLarge);
   // for(int h1=0; h1<ss.length(); h1++)
   // {
        g2d.drawString("No", 2, 100);
        g2d.drawString("of", 2, 115);
        g2d.drawString("pixels", 2, 130);
   //     line+=12;
   // }
    
    //g2d.rotate(Math.PI/2);
    g2d.drawString("Intensity", 300, 240);
    g2d.setFont(fontSmall);  
